...
class RegisterState {
  ...
  RegisterState( {required this.email,required this.fullName, required this.password});
  // copy with
  RegisterState copyWith({UserEmail? email, UserPassword? password, UserFullName? fullName}) {
